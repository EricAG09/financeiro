import { clamp, percentageOf } from "@/backend/domain/money";
import { monthsBetween, todayIsoDate } from "@/backend/domain/dates";
import type { FinancialGoal, GoalProgress } from "@/shared/types/goals";
